...
<body>
<div class="offline" id="banner">
  <a class="btn-debug" href="#" onclick="window.open('debug.html%X_UA_COMPATIBLE_URL%')">DEBUG</a>
  <h1 id="title">Karma - starting</h1>
</div>

<ul id="browsers"></ul>

<iframe height="100%" id="context" src="about:blank" width="100%"></iframe>
