...
- Always run plugins with side effects if certain options are
  set. [#140](https://github.com/csstools/postcss-plugins/issues/140)
...
- Added warnings and useful messages when a feature that doesn't exist is
  configured. [156](https://github.com/csstools/postcss-preset-env/issues/156).
...
- Fixed unexpected behaviours when using different versions of `postcss-values-parser` across the
  plugins [228](https://github.com/csstools/postcss-preset-env/issues/228)
...
- Fixed "Unknown word" errors in when parsing CSS
  values [224](https://github.com/csstools/postcss-preset-env/issues/224)
- Fixed "undefined" CSS values after transforms with
  postcss-place [225](https://github.com/csstools/postcss-preset-env/issues/225)
