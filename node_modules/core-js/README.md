...
> Modular standard library for JavaScript. Includes polyfills
> for [ECMAScript up to 2021](https://github.com/zloirock/core-js#ecmascript): [promises](https://github.com/zloirock/core-js#ecmascript-promise)
> , [symbols](https://github.com/zloirock/core-js#ecmascript-symbol)
> , [collections](https://github.com/zloirock/core-js#ecmascript-collections),
> iterators, [typed arrays](https://github.com/zloirock/core-js#ecmascript-typed-arrays), many other
> features, [ECMAScript proposals](https://github.com/zloirock/core-js#ecmascript-proposals)
> , [some cross-platform WHATWG / W3C features and proposals](#web-standards)
> like [`URL`](https://github.com/zloirock/core-js#url-and-urlsearchparams). You can load only required features or use it
...
`core-js` isn't backed by a company, so the future of this project depends on you. Become a sponsor or a backer if you
are interested in `core-js`: [**Open Collective**](https://opencollective.com/core-js), [**
Patreon**](https://patreon.com/zloirock), [**PayPal**](https://paypal.me/zloirock), **Bitcoin (
...
**It's a global version (first 2 examples), for more info
see [`core-js` documentation](https://github.com/zloirock/core-js/blob/master/README.md).**
