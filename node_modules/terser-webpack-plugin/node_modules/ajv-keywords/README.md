...
, `"boolean"` or `"symbol"`) or array of strings.
...
, `"RegExp"`, `"Promise"` or `"Buffer"`) or array of strings.
...
__Please note__: `{prohibited: ['foo', 'bar']}` is equivalent to `{not: {anyRequired: ['foo', 'bar']}}` (i.e. it has the
